...
def convert_avi_to_mpeg(input_file, working_directory, output_directory_name):
    ...
    #output_file = os.path.splitext(input_file)[0] + '.mpeg'
    ...
    if os.path.exists(output_file):
        ...
        if result.returncode == 0:
            print(f"Права доступа для файла успешно изменены на 644.")
        else:
            print(f"Произошла ошибка при изменении прав доступа файла:")
